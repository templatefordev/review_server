defmodule ReviewServerWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ReviewServerWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/review_server_web/templates",
        namespace: ReviewServerWeb

      # Import convenience functions from controllers
      import Phoenix.Controller, only: [get_flash: 1, get_flash: 2, view_module: 1]

      import ReviewServerWeb.ErrorHelpers
      import ReviewServerWeb.Gettext
      alias ReviewServerWeb.Router.Helpers, as: Routes
    end
  end
